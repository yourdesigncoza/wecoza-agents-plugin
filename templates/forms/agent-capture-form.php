...
<form id="agents-form" class="needs-validation ydcoza-compact-form" method="POST" enctype="multipart/form-data" novalidate>
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <input type="text" id="agent_id" name="agent_id" class="form-control form-control-sm" value="<?php echo FormHelpers::get_field_value($agent, 'id'); ?>" readonly>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            ...
            <select id="title" name="title" class="form-select form-select-sm <?php echo FormHelpers::get_error_class($errors, 'title'); ?>">
        ...
        <div class="col-md-3">
            ...
            <input type="text" id="surname" name="surname" class="form-control form-control-sm <?php echo FormHelpers::get_error_class($errors, 'surname'); ?>" 
                   value="<?php echo FormHelpers::get_field_value($agent, 'last_name'); ?>" required>
        ...
        <div class="col-md-2">
            ...
            <input type="text" id="known_as" name="known_as" class="form-control form-control-sm" 
                   value="<?php echo FormHelpers::get_field_value($agent, 'known_as'); ?>">
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <div id="sa_id_field" class="mb-3 <?php echo FormHelpers::get_field_value($agent, 'id_type', 'sa_id') !== 'sa_id' ? 'd-none' : ''; ?>">
                ...
                <input type="text" id="sa_id_no" name="sa_id_no" 
                       ...
                       value="<?php echo FormHelpers::get_field_value($agent, 'id_number'); ?>" maxlength="13">
        ...
        <div class="col-md-3">
            ...
            <input type="text" id="tel_number" name="tel_number" 
                   ...
                   value="<?php echo FormHelpers::get_field_value($agent, 'phone'); ?>" required>
        ...
        <div class="col-md-3">
            ...
            <input type="email" id="email_address" name="email_address" 
                   ...
                   value="<?php echo FormHelpers::get_field_value($agent, 'email'); ?>" required>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <input type="text" id="address_line_1" name="address_line_1" 
                   ...
                   value="<?php echo FormHelpers::get_field_value($agent, 'street_address'); ?>" required>
        ...
        <div class="col-md-6">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="quantum_maths_passed" name="quantum_maths_passed" value="1" 
                       <?php checked(FormHelpers::get_field_value($agent, 'quantum_maths_passed'), '1'); ?>>
        ...
        <div class="col-md-6">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="quantum_science_passed" name="quantum_science_passed" value="1" 
                       <?php checked(FormHelpers::get_field_value($agent, 'quantum_science_passed'), '1'); ?>>
        ...
        <div class="col-md-4">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="signed_agreement" name="signed_agreement" value="1" 
                       <?php checked(FormHelpers::get_field_value($agent, 'signed_agreement'), '1'); ?>>
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <input type="text" id="bank_name" name="bank_name" class="form-control form-control-sm" 
                   value="<?php echo FormHelpers::get_field_value($agent, 'bank_name'); ?>">
        </div>
